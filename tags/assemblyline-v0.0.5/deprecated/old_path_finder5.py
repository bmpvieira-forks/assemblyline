...
def find_suboptimal_paths(G, source, sink, allowed_paths, 
                          max_exhaustive=1000):
    '''
    ...
    if numpaths <= max_exhaustive:
        ...
        for res in find_paths_dfs(G, source, sink, allowed_paths,
                                  max_exhaustive):
            yield res
    else:
        ...
        for res in find_paths_markov(G, source, sink, allowed_paths,
                                     max_exhaustive-1):
            yield res
