...
def example3():
    ...
    G.add_node('SOURCE', attr_dict={NODE_DENSITY: MIN_NODE_DENSITY,
                                    NODE_LENGTH: 0})
    G.add_node('A', attr_dict={NODE_DENSITY: 5, NODE_LENGTH: 1})
    G.add_node('B', attr_dict={NODE_DENSITY: 100, NODE_LENGTH: 1})
    G.add_node('C', attr_dict={NODE_DENSITY: 5, NODE_LENGTH: 1})
    G.add_node('D', attr_dict={NODE_DENSITY: 2, NODE_LENGTH: 1})
    G.add_node('E', attr_dict={NODE_DENSITY: 2, NODE_LENGTH: 1})
    G.add_node('F', attr_dict={NODE_DENSITY: 50, NODE_LENGTH: 1})
    G.add_node('G', attr_dict={NODE_DENSITY: 10, NODE_LENGTH: 1})
    G.add_node('H', attr_dict={NODE_DENSITY: 100, NODE_LENGTH: 1})
    G.add_node('SINK', attr_dict={NODE_DENSITY: MIN_NODE_DENSITY, 
                                  NODE_LENGTH: 0})
    # add edges
    G.add_edges_from([('SOURCE','A'), ('A','B'),('A','C'),('B','D'),
                      ('B','E'),('D','F'),('E','F'),('F','G'),('G','SINK'),
                      ('C','G'),('C','H'),('H','G')])
    return G
...
class TestPathFinder(unittest.TestCase):
    ...
    def test_find_path(self):
        ...
        self.assertAlmostEqual(density, 5)
