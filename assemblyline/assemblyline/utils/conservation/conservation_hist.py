...
from base import BIGWIG_TO_BEDGRAPH_BIN, BEDFeature, which, \
    extract_bigwig_data, find_bigwig_files
...
def conservation_parallel(bed_file, chrom_bigwig_dict, sig_threshold, 
