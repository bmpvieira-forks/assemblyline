...
class GlobalStats(object):
    ...
    def report(self):
        ...
        lines = ["introns_total=%d" % (introns_total),
                 ...
                 "introns_precision=%f" % (self.introns_both / float(max(1,self.introns_both + self.introns_assembly_only))),
                 ...
                 "patterns_precision=%f" % (self.patterns_both / float(max(1,self.patterns_both + self.patterns_assembly_only))),
                 ...
                 "strand_cov_precision=%f" % (self.strand_cov_both / float(max(1,self.strand_cov_both + self.strand_cov_assembly_only))),
                 "strand_cov_recall=%f" % (self.strand_cov_both / float(max(1,self.strand_cov_both + self.strand_cov_ref_only))),
                 ...
                 "cov_precision=%f" % (self.cov_both / float(max(1,self.cov_both + self.cov_assembly_only))),
